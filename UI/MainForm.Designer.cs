namespace TrackTagger.UI {
	partial class MainForm {
		...
		private void InitializeComponent() {
			...
			rootFolderTextBox = new System.Windows.Forms.TextBox();
			namingSchemeTextBox = new System.Windows.Forms.TextBox();
			...
			// importFolderDialog
			// 
			importFolderDialog.Description = "Select a folder containing MP3 files";
			...
			yearCheckBox.Location = new System.Drawing.Point(101, 566);
			...
			genreCheckBox.Location = new System.Drawing.Point(101, 591);
			...
			clearExistingTagsCheckBox.TabIndex = 20;
			...
			trackNumberCheckBox.Location = new System.Drawing.Point(101, 616);
			trackNumberCheckBox.Margin = new System.Windows.Forms.Padding(2, 3, 2, 3);
			trackNumberCheckBox.Name = "trackNumberCheckBox";
			trackNumberCheckBox.Size = new System.Drawing.Size(59, 17);
			...
			// trackListView
			// 
			trackListView.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] { columnHeader1, columnHeader2, columnHeader3, columnHeader4, columnHeader5, columnHeader6, columnHeader7, columnHeader8, columnHeader9 });
			...
			trackListView.ColumnClick += FilesListView_ColumnClick;
			trackListView.SelectedIndexChanged += FilesListView_SelectedIndexChanged;
			trackListView.KeyDown += FilesListView_KeyDown;
			// 
			// columnHeader1
			// 
			columnHeader1.Text = "Filename";
			columnHeader1.Width = 231;
			// 
			// columnHeader2
			// 
			...
			albumArtPicture.Location = new System.Drawing.Point(897, 531);
			...
			searchTextBox.Location = new System.Drawing.Point(574, 589);
			searchTextBox.Name = "searchTextBox";
			searchTextBox.Size = new System.Drawing.Size(314, 22);
			searchTextBox.TabIndex = 24;
			searchTextBox.KeyDown += SearchBox_KeyDown;
			// 
			// tracksDropDown
			// 
			...
			tracksDropDown.Location = new System.Drawing.Point(574, 639);
			tracksDropDown.Name = "tracksDropDown";
			tracksDropDown.Size = new System.Drawing.Size(314, 21);
			tracksDropDown.TabIndex = 26;
			...
			label1.Location = new System.Drawing.Point(574, 531);
			label1.Name = "label1";
			...
			importFolderButton.TabIndex = 28;
			...
			importSubfoldersCheckBox.Checked = true;
			importSubfoldersCheckBox.CheckState = System.Windows.Forms.CheckState.Checked;
			...
			importSubfoldersCheckBox.TabIndex = 18;
			...
			matchOnImportCheckBox.TabIndex = 19;
			...
			label5.TabIndex = 10;
			label5.Text = "Renaming Settings";
			// 
			// rootFolderTextBox
			// 
			rootFolderTextBox.Location = new System.Drawing.Point(179, 589);
			rootFolderTextBox.Name = "rootFolderTextBox";
			rootFolderTextBox.Size = new System.Drawing.Size(233, 22);
			rootFolderTextBox.TabIndex = 13;
			rootFolderTextBox.Text = "%originalFolder%";
			// 
			// namingSchemeTextBox
			// 
			namingSchemeTextBox.Location = new System.Drawing.Point(179, 639);
			namingSchemeTextBox.Name = "namingSchemeTextBox";
			namingSchemeTextBox.Size = new System.Drawing.Size(233, 22);
			namingSchemeTextBox.TabIndex = 15;
			namingSchemeTextBox.Text = "%artist% - %title%";
			// 
			// label6
			// 
			...
			renameFilesCheckBox.TabIndex = 11;
			...
			label10.Location = new System.Drawing.Point(574, 570);
			...
			label11.Location = new System.Drawing.Point(574, 620);
			...
			Controls.Add(label7);
			Controls.Add(label6);
			Controls.Add(namingSchemeTextBox);
